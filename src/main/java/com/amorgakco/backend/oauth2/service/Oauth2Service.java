...
import com.amorgakco.backend.oauth2.provider.Oauth2ProviderComposite;
...
public class Oauth2Service {
    ...
    public String getRedirectionLoginUrl(final Oauth2ProviderType oauth2ProviderType) {
        final Oauth2ProviderService providerService =
                oauth2ProviderComposite.getProvider(oauth2ProviderType);
    ...
    public Oauth2MemberResponse login(
        ...
        final Oauth2ProviderService providerService =
                oauth2ProviderComposite.getProvider(oauth2ProviderType);
        final Oauth2Member oauth2Member = providerService.getOauth2Member(authCode);
